...
namespace Membership.API
{
    public class Startup
    {
        ...
        {
            services.AddMediatR(typeof(UserAppContext));

            services.AddScoped<GenerateRef>();
            services.AddScoped<ApplyRefCode>();
            services.AddScoped<UserAppContext>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Membership.API", Version = "v1" });
            });
        }
